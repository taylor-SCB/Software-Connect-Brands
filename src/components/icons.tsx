// Inline stroke icons. Kept local instead of pulling an icon package so
// the bundle stays small and every glyph matches the same 1.6px grid.
...
export const IconSparkles = (p: IconProps) => (
  <Svg {...p}>
    ...
    <path d="M19 15l.8 2L22 17.8l-2.2.8L19 21l-.8-2.4-2.2-.8 2.2-.8z" />
  </Svg>
);
